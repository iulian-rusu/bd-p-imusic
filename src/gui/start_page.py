...
class StartPage(BasePage, ABC):
    ...
    def build_gui(self):
        ...
        filler_top.grid(pady='170', columnspan='2')
        filler_bot = tk.Frame(self.login_frame)
        filler_bot.grid(row='4', pady='170', columnspan='2')
        self.username_lbl = tk.Label(self.login_frame)
        self.username_lbl.config(background='#d3d3d3', font='{Sawasdee} 12 {}', text='username:')
        self.username_lbl.grid(row='1', padx='15', pady='20', sticky='e')
        self.username_entry = tk.Entry(self.login_frame, font='{Sawasdee} 12 {}')
        ...
        self.password_lbl.config(background='#d3d3d3', font='{Sawasdee} 12 {}', text='password:')
        self.password_lbl.grid(padx='15', pady='20', row='2', sticky='e')
        self.password_entry = tk.Entry(self.login_frame, show=".", font='{Sawasdee} 12 {bold}')
        ...
        filler_top.grid(pady='190', columnspan='2')
        filler_bot = tk.Frame(self.info_frame)
        filler_bot.grid(row='3', pady='190', columnspan='2')
        ...
        self.app_info_msg.config(font='{Sawasdee} 16 {bold}', takefocus=False,
                                 text='Welcome to iMusic.\nPlease log in to your account.',
                                 width='300', background='#c3c3c3')
        self.app_info_msg.grid(padx='50', row='1')
        self.description_msg = tk.Message(self.info_frame)
        self.description_msg.config(font='{Sawasdee} 14 {}', takefocus=False,
        ...
        self.card_type_spinbox.config(font='{Sawasdee} 12 {}', relief='flat', values='credit debit', width='10')
        ...
        year = tk.StringVar()
        self.exp_y_spinbox.config(font='{Sawasdee} 12 {}', from_='2020', to='2099', increment='1', relief='flat')
        ...
        month = tk.StringVar()
        self.exp_m_spinbox.config(font='{Sawasdee} 12 {}', from_='1', to='12', increment='1', relief='flat')
        ...
        day = tk.StringVar()
        self.exp_d_spinbox.config(font='{Sawasdee} 12 {}', from_='1', to='31', increment='1', relief='flat')
        ...
        self.reg_btn.config(activebackground='#9a9a9a', background='#b1b1b1', font='{Sawasdee} 12 {}', relief='flat')
